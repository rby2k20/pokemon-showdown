...
let BattleMovedex = {
	...
	counter: {
		...
		damageCallback(pokemon, target) {
			...
			if (['Normal', 'Fighting'].includes(target.statusData.failedMoveid.type) && this.lastDamage <= 0 || ['!Normal', '!Fighting'].includes(target.statusData.failedMoveid.type) && this.lastDamage > 0) {
