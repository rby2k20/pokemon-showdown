...
let BattleMovedex = {
	...
	counter: {
		...
		damageCallback(pokemon, target) {
			...
			if (['Normal', 'Fighting'].includes(pokemon.statusData.failedMoveid) && this.lastDamage <= 0 || ['!Normal', '!Fighting'].includes(pokemon.statusData.failedMoveid) && this.lastDamage > 0) {
