...
let BattleMovedex = {
	...
	counter: {
		...
		damageCallback(pokemon, target) {
			...
			if (['Normal', 'Fighting'].includes(this.pokemon.statusData.failedMoveid) && this.lastDamage <= 0 || ['!Normal', '!Fighting'].includes(this.pokemon.statusData.failedMoveid) && this.lastDamage > 0) {
